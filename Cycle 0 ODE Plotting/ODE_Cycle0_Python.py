...
def wrap_full(k1,k2,k3,k4,k5,k6,alpha,beta,k,L,m1,m2,d1,d2,d3,d4,d5,d6,d7,d8,
              c_dia,c_h2o2,c_oxyrn, c_oxyra,c_poxy,c_pkat,c_mgfp,c_gfp,c_mrfp,c_rfp):
...
def main_full(k1,k2,k3,k4,k5,k6,alpha,beta,k,L,m1,m2,d1,d2,d3,d4,d5,d6,d7,d8,
              c_dia,c_h2o2,c_oxyrn, c_oxyra,c_poxy,c_pkat,c_mgfp,c_gfp,c_mrfp,c_rfp): 
    
    global timerx, timeperiod
    z = wrap_full(k1,k2,k3,k4,k5,k6,alpha,beta,k,L,m1,m2,d1,d2,d3,d4,d5,d6,d7,d8,
                  c_dia,c_h2o2,c_oxyrn, c_oxyra,c_poxy,c_pkat,c_mgfp,c_gfp,c_mrfp,c_rfp)
    if True:
        t = np.linspace(0, timerx, timeperiod)
  
        plt.plot(t,z[:,7],'g-',label='gfp')
        plt.plot(t,z[:,9],'r-',label='rfp')
...
if __name__ == '__main__':
    c_dia = 0.01
    r= main_full(k1,k2,k3,k4,k5,k6,alpha,beta,k,L,m1,m2,d1,d2,d3,d4,d5,d6,d7,d8,
                  c_dia,c_h2o2,c_oxyrn, c_oxyra,c_poxy,c_pkat,c_mgfp,c_gfp,c_mrfp,c_rfp)
    print(r)
